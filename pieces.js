export const king = `<div class="piece" id="king">
...
export const queen = `<div class="piece " data-score="9" id="queen">
...
export const rook = `<div class="piece" data-score="5" id="rook">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
    <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
...
export const bishop = `<div class="piece" data-score="3" id="bishop">
...
export const knight = `<div class="piece" data-score="3" id="knight">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
    <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
...
export const pawn = `<div class="piece" data-score="1" id="pawn">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
    <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
